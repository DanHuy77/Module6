package com.sneaker.personal_project_sneaker.jwt.jwt;

import com.sneaker.personal_project_sneaker.dto.response.ResponseMessage;
...
public class JwtProvider {
    ...
    private String jwtSecret = "secret"; // chữ ký của token
